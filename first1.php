...
<!--span class="prfil-img"><img src="home.jpeg" alt=""> </span--> 
	...
	echo "Welcome ".$_SESSION['prn']."."." This is first page.";
	echo "<br>";
	echo "Review your information!!";
	echo "<br>";
...
// output data of each row
    while($row = mysqli_fetch_assoc($result)) {
		...
		mysqli_close($conn);*/
	?>
	<a href="third.php"><input type="button" value="Logout"></a>
<a href="second.php"><input type="button" value="Update Details"></a>
