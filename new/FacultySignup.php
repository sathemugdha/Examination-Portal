                ...
                <div class="col-md-10 offset=md-1">
                    <div class="row">
                        ...
                        <div class="col-md-7 register-right">
                            <h2>Register Here</h2>
                            <form action="facultyaction.php" method = "post">
                            <div class="register-form">
                                <div class="form-group">
                                    <input type="text" class="form-control"  name="cname" id="name" placeholder="Faculty Name" pattern="[A-Za-z]+" required >
                                </div>     
                                  
                                 <div class="form-group">
                                    <input type="number" class="form-control" name="number" id="cnumber" placeholder="Contact Number" pattern="[789][0-9]{9}" required>
                                </div>    
                                 <div class="form-group">
